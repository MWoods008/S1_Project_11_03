...
// Set variable randomQ to function with arguements of 0 and.
var randomQ = randomInt(0, 9);

// uses n to select random quote.
function getQuote(n) {
    var quotes = [
...
// Set variable of quote to document with id of q.
var quote = document.getElementById("q");

// set quote text to output of the function.
